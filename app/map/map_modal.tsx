...
import {Button, Dialog, ScrollView, SizableText, Unspaced, XStack, YStack,} from 'tamagui';
        ...
        <>
            <Dialog modal open={visible} onOpenChange={onClose}>
                <Dialog.Portal>
                    ...
                    >
                        <ScrollView>
                            <Dialog.Title col='$text' fontSize="$7" mt="$5" marginHorizontal="$2" textAlign="center">
                                Kamer {roomNumber}
                            </Dialog.Title>
                            ...
                            {showSimilarPatients && (
                                <YStack marginHorizontal="$2" mb="$8">
                                    ...
                                    {similarPatients.length > 0 ? (
                                        ...
                                        <SizableText col='$text'>Geen patiënten met een zelfde ziektebeeld gevonden</SizableText>
                                    )}
                                </YStack>
                            )}
                            ...
                            <XStack ai="center" jc="center" marginHorizontal="auto" space="$4" mt="$4">
                                <Button
                                    borderRadius="$12"
                                    borderColor={patients.length === 0 ? "$gray" : "$accent_focus"}
                                    color='white'
                                    bg={patients.length === 0 ? "$gray7" : "$accent"}
                                    pressStyle={{bg: patients.length === 0 ? "$gray" : "$accent_focus"}}
